			...
			<div id="carousel-slider" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					<div class="item active">
						<img src="resources/images/images6.jpg" class="img-responsive"
							alt="">
					</div>
					<div class="item">
						<img src="resources/images/images1.jpg" class="img-responsive"
							alt="">
					</div>
					<div class="item">
						<img src="resources/images/images2.jpg" class="img-responsive"
							alt="">
					</div>
				</div>
